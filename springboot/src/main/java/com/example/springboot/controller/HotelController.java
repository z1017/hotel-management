...
import com.example.springboot.controller.request.HotelPageRequest;
...
public class HotelController {
    ...
    public Result uploadFile(MultipartFile file) {
        ...
        try {
            ...
            String url = "http://localhost:9090/api/hotel/file/download/" + flag + "?&token=" + token;
    ...
    @PostMapping("/save")
    public Result save(@RequestBody Hotel obj) {
        hotelService.save(obj);
        return Result.success();
    }

    @PutMapping("/update")
    public Result update(@RequestBody Hotel obj) {
        hotelService.update(obj);
        return Result.success();
    }
    ...
    public Result getById(@PathVariable Integer id) {
        Hotel obj = hotelService.getById(id);
    ...
    @GetMapping("/page")
    public Result page(HotelPageRequest pageRequest) {
        return Result.success(hotelService.page(pageRequest));
    }
